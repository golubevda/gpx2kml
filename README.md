...
- при замене координат в описании тайника и записях блокнота на ссылки для отображения текста ссылки 
теперь используется оригинальное, авторское написание координат
...
- добавлена возможность указывать директорию в качестве входного параметра: файлы *.gpx внутри бутут сконвертированы 
в единый KML/KMZ с уникальным набором точек из них
...
## Запуск конвертации
[Скачать последний релиз](https://github.com/golubevda/gpx2kml/raw/main/webres/gpx2kml-2.0.jar) или собрать исполняемый jar из исходного кода самостоятельно
